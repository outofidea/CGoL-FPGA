...
module life #(
    ...
    output cell_address_class#(WIDTH, HEIGHT)::cell_address state_cell_addr, //! EVIL EVIL EVIL EVIL EVIL
    input logic state_cell_data_in,
    input logic state_cell_data_valid,
    output logic state_cell_data_out,
                    ...
                    unique case (corners[1:0])
                        2'b00: begin
                            ...
                            unique case (neighbor_read_count)  //! trust me vro
                                0: begin
                                    ...
                                    state_cell_addr = cur_cell_addr;
                                end

                                1: begin
                                    //put neigh 4 addr, which is x+1
                                    state_cell_addr = neighbor4_addr;
                                end

                                2: begin
                                    //put neigh 6 addr, which is y+1
                                    state_cell_addr = neighbor6_addr;
                                end

                                3: begin
                                    //put neigh 7 addr, which is x+1. y+1
                                    state_cell_addr = neighbor7_addr;
                                end
                        ...
                        2'b01: begin
                            ...
                            unique case (neighbor_read_count)  //! trust me vro
                                ...
                                1: begin
                                    ...
                                    state_cell_addr = neighbor3_addr;
                                end

                                2: begin
                                    //put neigh 5 addr, which is x-1. y+1
                                    state_cell_addr = neighbor5_addr;
                                end
                        ...
                        2'b10: begin
                            ...
                            unique case (neighbor_read_count)  //! trust me vro
                                ...
                                1: begin
                                    ...
                                    state_cell_addr = neighbor1_addr;
                                end

                                2: begin
                                    //put neigh 2 addr, which is x+1. y-1
                                    state_cell_addr = neighbor2_addr;
                                end
                        ...
                        2'b11: begin
                            ...
                            unique case (neighbor_read_count)  //! trust me vro
                                ...
                                2: begin
                                    //put neigh 0
                                    state_cell_addr = neighbor0_addr;
                                end
            ...
            unique case (life_state)
                ...
                CORNERS_CHECK: begin
                    if (cur_cell_addr.cell_addr_x == 0) begin  // left side
                        {cur_neighbors[0], cur_neighbors[3], cur_neighbors[5]} <= '0;
                        corners[2]                                             <= 1;
                    end
                    if (cur_cell_addr.cell_addr_x == WIDTH - 1) begin //? Will shit itself if over/underflows
                        {cur_neighbors[2], cur_neighbors[4], cur_neighbors[7]} <= '0;
                        corners[2]                                             <= 1;
                        corners[0]                                             <= 1;
                    end
                ...
                NEIGH: begin 
                    ...
                    if (prev_neighbor_avail) begin
                        ...
                        if (corners[2] == 1) begin
                            ...
                            unique case (corners[1:0])
                                2'b00: begin
                                    ...
                                    unique case (neighbor_read_count)  //! trust me vro
                                        ...
                                        1: begin
                                            cur_cell_state      <= state_cell_data_in;
                                            neighbor_read_count <= neighbor_read_count + 1;
                                        end

                                        2: begin
                                            cur_neighbors[4]    <= state_cell_data_in;
                                            neighbor_read_count <= neighbor_read_count + 1;
                                        end

                                        3: begin
                                            cur_neighbors[6]    <= state_cell_data_in;
                                            neighbor_read_count <= neighbor_read_count + 1;
                                        end

                                        4: begin
                                            cur_neighbors[7]    <= state_cell_data_in;
                                            neighbor_read_count <= 0;
                                        end
                                    endcase
                            ...
                            cur_neighbors[1:0] <= prev_neighbors[1:0];
                            cur_neighbors[3]   <= prev_neighbors[2];
                            cur_neighbors[6:5] <= prev_neighbors[4:3];
