...
module life #(
    ...
    */
    ...
    logic [7:0] corner_neighbor_override;
    ...
    always_ff @(posedge clk) begin : life_logic_ff
        ...
        unique case (life_state)
            ...
            */
            ...
            CORNERS: begin
                if (cur_cell_addr.cell_addr_x == 0) begin
                    corner_neighbor_override[0] <= 0;
                    corner_neighbor_override[3] <= 0;
                    corner_neighbor_override[5] <= 0;
                end

                if (cur_cell_addr.cell_addr_x == WIDTH - 1) begin
                    corner_neighbor_override[2] <= 0;
                    corner_neighbor_override[4] <= 0;
                    corner_neighbor_override[7] <= 0;
                end

                if (cur_cell_addr.cell_addr_y == 0) begin
                    corner_neighbor_override[0] <= 0;
                    corner_neighbor_override[1] <= 0;
                    corner_neighbor_override[2] <= 0;
                end

                if (cur_cell_addr.cell_addr_y == HEIGHT - 1) begin
                    corner_neighbor_override[5] <= 0;
                    corner_neighbor_override[6] <= 0;
                    corner_neighbor_override[7] <= 0;
                end
            end
            ...
            NEIGH: begin
                ...
                unique case (1'b1)  //! more shenanigans
                    ...
                    cells_read_state[2]: begin
                        tot_neighbors[0] <= (state_bram_cell_data_in & corner_neighbor_override[0]);
                        cells_read_state <= 11'b00000001000;
                    end

                    cells_read_state[3]: begin
                        tot_neighbors    <= tot_neighbors + (state_bram_cell_data_in & corner_neighbor_override[1]);
                        cells_read_state <= 11'b00000010000;
                    end

                    cells_read_state[4]: begin
                        tot_neighbors    <= tot_neighbors + (state_bram_cell_data_in & corner_neighbor_override[2]);
                        cells_read_state <= 11'b00000100000;
                    end

                    cells_read_state[5]: begin
                        tot_neighbors    <= tot_neighbors + (state_bram_cell_data_in & corner_neighbor_override[3]);
                        cells_read_state <= 11'b00001000000;
                    end

                    cells_read_state[6]: begin
                        tot_neighbors    <= tot_neighbors + (state_bram_cell_data_in & corner_neighbor_override[4]);
                        cells_read_state <= 11'b00010000000;
                    end

                    cells_read_state[7]: begin
                        tot_neighbors    <= tot_neighbors + (state_bram_cell_data_in & corner_neighbor_override[5]);
                        cells_read_state <= 11'b00100000000;
                    end

                    cells_read_state[8]: begin
                        tot_neighbors    <= tot_neighbors + (state_bram_cell_data_in & corner_neighbor_override[6]);
                        cells_read_state <= 11'b01000000000;
                    end

                    cells_read_state[9]: begin
                        tot_neighbors    <= tot_neighbors + (state_bram_cell_data_in & corner_neighbor_override[7]);
            ...
            CALC: begin
                if (cur_cell_state) begin
                    if ((tot_neighbors < 2) | (tot_neighbors > 3)) begin
                        next_cell_state <= 0;
                    end else begin
                        next_cell_state <= 1;
                    end
